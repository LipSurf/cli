...
//   }
// }
function build(options, plugins) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const globbedTs = globby_1.default.sync("dist/tmp/*/*.js");
        ...
        if (watch) {
            ...
            for (const pluginName of pluginNames) {
                ...
                //   )
                // );
                const codeParts = yield Promise.all(pluginWLanguageFiles.map((f) => fs_1.promises.readFile(f, { encoding: "utf8" })));
                console.log("globbed pluginNames", pluginWLanguageFiles);
                transform_1.make(codeParts[0], resolveDir);
