    ...
    ParsedPlugin.prototype.replaceCmdsAbovePlan = function (commandsObjs, pluginPlan, buildForPlan) {
        ...
        var replaced = commandsObjs
            ...
            if (!planProp) {
                ...
                var cmdPlan = planProp.value.value;
            ...
            if (!pageFnProp) {
                cmdObj.node.properties.push(_this.j.property('init', _this.j.identifier('pageFn'), _this.j.template.expression(templateObject_2 || (templateObject_2 = __makeTemplateObject(["showNeedsUpgradeError"], ["showNeedsUpgradeError"])))));
            }
            return cmdObj;
        }, this.j.Property)
            .find(this.j.Property, { key: { name: "pageFn" } })
            .find(this.j.ArrowFunctionExpression);
        replaced.replaceWith(this.j.template.expression(templateObject_3 || (templateObject_3 = __makeTemplateObject(["showNeedsUpgradeError"], ["showNeedsUpgradeError"]))));
